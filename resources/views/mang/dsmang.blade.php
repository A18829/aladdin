    ...
    <div class="card">
        ...
        <div class="card-body">
            <div class="table-responsive">
                <a href="{{ route('mangs.export') }}" class="badge badge-black mb-3">Xuất Excel</a>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="form-button-action" style="display: flex; align-items: center;">
                                    <button type="button" class="btn btn-link btn-primary btn-lg me-2" onclick="window.location='{{ route('mang.edit', $mang->id) }}'" data-original-title="Edit Task">
