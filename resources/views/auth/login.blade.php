...
<head>
  ...
  <!-- Nucleo Icons -->
  <link href="../public/gd/assets/css/nucleo-icons.css" rel="stylesheet" />
  <link href="../public/gd/assets/css/nucleo-svg.css" rel="stylesheet" />
  <!-- Font Awesome Icons -->
  ...
  <main class="main-content  mt-0">
          ...
          <div class="row align-items-center justify-content-lg-between">
            <div class="col-12 col-md-6 my-auto">
              <div class="copyright text-center text-sm text-white text-lg-start">
                ...
                <a href="#" class="font-weight-bold text-white" target="_blank"> Hieu</a>
    ...
    <!--    <div class="col-12 col-md-6">
              <ul class="nav nav-footer justify-content-center justify-content-lg-end">
                <li class="nav-item">
                  <a href="https://www.creative-tim.com" class="nav-link text-white" target="_blank">H</a>
                </li>
                <li class="nav-item">
